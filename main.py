...
def get_predicted_value(patient_symptoms):
    ...
    invalid_symptoms = [symptom for symptom in normalized_symptoms if symptom not in symptoms_dict]
    if invalid_symptoms:
        return f"Invalid symptoms detected: {', '.join(invalid_symptoms)}. Please check your input."
    ...
    return diseases_list.get(predicted_index, predicted_index)
